// scripts/components/MangaSection.js
...
function MangaSection({ addToCart }) {
    ...
    useEffect(() => {
        fetch('./data/manga.json')
            ...
            .catch(error => console.error('Error loading Manga:', error));
    }, []);

    return (
        <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white px-5 md:px-16 py-10">
            <h2 className="text-3xl font-normal mb-8 uppercase dark:text-white">MANGA</h2>
...
window.MangaSection = MangaSection;