// scripts/components/NarutoSection.js
...
function NarutoSection({ addToCart }) {
    ...
    useEffect(() => {
        ...
        fetch('./data/naruto.json')
            ...
            .catch(error => console.error('Error loading Naruto:', error));
    }, []);
    ...
    return (
        ...
        <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white px-5 md:px-16 py-10">
            <h2 className="text-3xl font-normal mb-8 uppercase dark:text-white">NARUTO</h2>
...
window.NarutoSection = NarutoSection;